...
export const translations = {
  nl: {
    ...
    // ADR 0009: attention scope strings (NL)
    boxModeScopeAttention: 'Boeken die aandacht nodig hebben',
    boxModeScopeAttentionTooltip: 'Boeken waar FSRS vindt dat je meer moeite mee hebt, of die overdue zijn voor herhaling.',
    boxModeAttentionSelected: 'Geselecteerd: {n} boeken die FSRS als moeilijk of overdue markeert.',
    boxModeScopeAttentionInsufficientData: 'Train eerst meer in Quiz Modus om data op te bouwen.',
    boxModeScopeAttentionNoOutliers: 'Geen duidelijk zwakke boeken — je staat er goed voor!',
    boxModeScopeAttentionTooFew: 'Nog niet genoeg boeken om te oefenen.',
  ...
  en: {
    ...
    // ADR 0009: attention scope strings (EN)
    boxModeScopeAttention: 'Books that need attention',
    boxModeScopeAttentionTooltip: 'Books FSRS finds harder for you, or that are overdue for review.',
    boxModeAttentionSelected: 'Selected: {n} books FSRS marks as hard or overdue.',
    boxModeScopeAttentionInsufficientData: 'Train more in Quiz Mode first to build up data.',
    boxModeScopeAttentionNoOutliers: 'No clearly weak books — you\'re in good shape!',
    boxModeScopeAttentionTooFew: 'Not enough books to practice yet.',

...
> **This file is no longer maintained.** It is preserved as a historical record of project changes from early development through v6 commit 35 (May 2026). After commit 35, the project switched to:
>
> - **Conventional Commits** — for routine changes; the commit log is the source of truth (`git log --oneline`)
> - **Architecture Decision Records (ADRs)** — for significant design decisions; see [`docs/adr/`](../adr/)
>
> No new entries are added below. The content of this file is preserved verbatim from the last update.
